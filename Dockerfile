...
LABEL org.opencontainers.image.description="Simple utility container to facilitate backing up my Mastodon database to my NAS" org.opencontainers.image.authors="kevinisageek"
